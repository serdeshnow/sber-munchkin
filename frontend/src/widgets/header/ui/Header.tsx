...
export const Header: React.FC<HeaderProps> = ({ className }) => {
  ...
  return (
    <header
      className={cn(
        'flex flex-wrap items-center justify-between bg-dark-gray-500 px-4 py-3 gap-4 sm:px-6 sm:py-4 md:px-10 md:gap-6 lg:gap-5',
        className,
      )}
    >
      <Title onClick={() => navigate('/')}>Манчкины</Title>
